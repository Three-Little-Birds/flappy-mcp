"""Command-line entry point for flappy-mcp."""
...
SERVICE_NAME = "flappy-mcp"
SERVICE_DESCRIPTION = "Flappy dynamics simulator exposed via MCP."


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog=SERVICE_NAME,
        description="Run the flappy MCP server (STDIO transport).",
    )
    parser.add_argument(
        "--describe",
        action="store_true",
